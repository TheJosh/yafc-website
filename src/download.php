...
<p><a href="/upload/yafc-<?php echo $latest[0]; ?>.tar.xz">Download Yafc <?php echo $latest[0]; ?></a> (released <?php echo $latest[1]; ?>, <a href="/upload/yafc-<?php echo $latest[0]; ?>.tar.xz.asc">signature</a>)</p>
...
<ul>
	<?php foreach ($releases as $row): ?>
		<li><a href="/upload/yafc-<?php echo $row[0]; ?>.tar.xz"><?php echo $row[0]; ?></a> (released <?php echo $row[1]; ?>, <a href="/upload/yafc-<?php echo $row[0]; ?>.tar.xz.asc">signature</a>)
	<?php endforeach; ?>
</ul>
